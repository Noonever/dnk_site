...
export default function AlbumReleaseRequest() {
    ...
    const handleSubmit = async () => {
        ...
        for (let track of trackForms) {
            ...
            formData.append(`${trackForms.indexOf(track)}-track-musicAuthorsNames`, track.musicAuthorsNames)
            formData.append(`${trackForms.indexOf(track)}-track-lyricistsNames`, track.lyricistsNames)
            formData.append(`${trackForms.indexOf(track)}-track-phonogramProducersNames`, track.phonogramProducersNames)
        }
        try {
