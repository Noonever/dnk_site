...
const kzPassportDataNumberRePattern = /^[A-Za-z]\d{8}$/
const byPassportDataNumberRePattern = /^[A-Za-z]{2}\d{7}$/
...
export default function AlbumReleaseRequest() {
    ...
    const handleChangeCurrentPassport = (fieldName: keyof RuPassportData | keyof KzPassportData | keyof ByPassportData | keyof ForeignPassportData, value: string) => {
        ...
        if (passportType === 'ru') {
            ...
            let isValid = true
            const newKzPassportData = { ...currentPassport } as KzPassportData
            const kzFieldName = fieldName as keyof KzPassportData

            if (fieldName === 'fullName') {
                isValid = fullNameRePattern.test(value) || value === ''
            } else if (fieldName === 'number') {
                isValid = kzPassportDataNumberRePattern.test(value) || value === ''
            ...
            newKzPassportData[kzFieldName] = value
            newPassport = newKzPassportData

        } else if (passportType === 'by') {
            let isValid = true
            const newByPassportData = { ...currentPassport } as ByPassportData
            const byFieldName = fieldName as keyof ByPassportData

            if (fieldName === 'fullName') {
                isValid = fullNameRePattern.test(value) || value === ''
            } else if (fieldName === 'number') {
                isValid = byPassportDataNumberRePattern.test(value) || value === ''
            }
            ...
            newByPassportData[byFieldName] = value
            newPassport = newByPassportData

        } else if (passportType === 'foreign') {
            const newForeignPassportData = { ...currentPassport } as ForeignPassportData
            const foreignFieldName = fieldName as keyof ForeignPassportData

            newForeignPassportData[foreignFieldName] = value
            newPassport = newForeignPassportData
        }
    ...
    const renderPassport = (): JSX.Element => {
        ...
        if (passportType === 'ru') {
            ...
            const kzPassportData = passportData as KzPassportData
            passportSection = (
                <div className="passport-section">
                    <div className="passport-fields">
                        <div style={{ display: "flex", flexDirection: "column", marginTop: "2vh", marginBottom: "3vh" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", marginTop: "2vh", marginBottom: "3vh" }}>
                            ...
                            <input
                                className="field"
                                value={kzPassportData.birthDate}
                                onChange={(event) => handleChangeCurrentPassport('birthDate', event.target.value)}
                                type={"date"}
                            />
                        </div>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", marginTop: "2vh", marginBottom: "3vh" }}>
                            ...
                            <input
                                className="field"
                                value={kzPassportData.issueDate}
                                onChange={(event) => handleChangeCurrentPassport('issueDate', event.target.value)}
                                type={"date"}
                            />
                        </div>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", marginTop: "2vh", marginBottom: "3vh" }}>
                            ...
                            <input
                                className="field"
                                value={kzPassportData.registrationAddress}
            ...
            const byPassportData = passportData as ByPassportData
            passportSection = (
                <div className="passport-section">
                    <div className="passport-fields">
                        <div style={{ display: "flex", flexDirection: "column", marginTop: "2vh", marginBottom: "3vh" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", marginTop: "2vh", marginBottom: "3vh" }}>
                            ...
                            <input
                                className="field"
                                value={byPassportData.birthDate}
                                onChange={(event) => handleChangeCurrentPassport('birthDate', event.target.value)}
                                type={"date"}
                            />
                        </div>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", marginTop: "2vh", marginBottom: "3vh" }}>
                            ...
                            <input
                                className="field"
                                value={byPassportData.issueDate}
                                onChange={(event) => handleChangeCurrentPassport('issueDate', event.target.value)}
                                type={"date"}
                            />
                        </div>
                        <div style={{ display: "flex", flexDirection: "column", marginTop: "2vh", marginBottom: "3vh" }}>
                            ...
                            <input
                                className="field"
                                value={byPassportData.registrationAddress}
                                onChange={(event) => handleChangeCurrentPassport('registrationAddress', event.target.value)}
                            />
                        </div>
                    </div>
            ...
            const foreignPassportData = passportData as ForeignPassportData
            passportSection = (
                <div className="passport-section">
                    <div className="passport-fields">
                        <div style={{ display: "flex", flexDirection: "column", marginTop: "2vh", marginBottom: "3vh" }}>
                            ...
                            <input
                                disabled={true}
                                className="field"
                                value={foreignPassportData.fullName}
                                onChange={(event) => handleChangeCurrentPassport('fullName', event.target.value)}
                            />
                        </div>
                        <div style={{ display: "flex", flexDirection: "column", marginTop: "2vh", marginBottom: "3vh" }}>
                            ...
                            <input
                                className="field"
                                value={foreignPassportData.citizenship}
                        ...
                        <div style={{ display: "flex", flexDirection: "column", marginTop: "2vh", marginBottom: "3vh" }}>
                            ...
                            <input
                                className="field"
                                value={foreignPassportData.birthDate}
                                onChange={(event) => handleChangeCurrentPassport('birthDate', event.target.value)}
                                type={"date"}
                            />
                        </div>
                        <div style={{ display: "flex", flexDirection: "column", marginTop: "2vh", marginBottom: "3vh" }}>
                            ...
                            <input
                                className="field"
                                value={foreignPassportData.number}
                                onChange={(event) => handleChangeCurrentPassport('number', event.target.value)}
                            />
                        </div>
                        <div style={{ display: "flex", flexDirection: "column", marginTop: "2vh", marginBottom: "3vh" }}>
                            ...
                            <input
                                className="field"
                                value={foreignPassportData.idNumber}
                                onChange={(event) => handleChangeCurrentPassport('idNumber', event.target.value)}
                            />
                        </div>
                        <div style={{ display: "flex", flexDirection: "column", marginTop: "2vh", marginBottom: "3vh" }}>
                            ...
                            <input
                                className="field"
                                value={foreignPassportData.issuedBy}
                                onChange={(event) => handleChangeCurrentPassport('issuedBy', event.target.value)}
                            />
                        </div>
                        <div style={{ display: "flex", flexDirection: "column", marginTop: "2vh", marginBottom: "3vh" }}>
                            ...
                            <input
                                className="field"
                                value={foreignPassportData.issueDate}
                                onChange={(event) => handleChangeCurrentPassport('issueDate', event.target.value)}
                                type={"date"}
                            />
                        </div>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", marginTop: "2vh", marginBottom: "3vh" }}>
                            ...
                            <input
                                className="field"
                                value={foreignPassportData.registrationAddress}
                                onChange={(event) => handleChangeCurrentPassport('registrationAddress', event.target.value)}
                            />
                        </div>
                    </div>
